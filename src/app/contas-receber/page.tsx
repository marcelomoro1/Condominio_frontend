      ...
      <div className="flex flex-col md:flex-row justify-between items-center mb-16 gap-8">
        <div className="flex items-center gap-5">
          ...
          <div>
            ...
            <p className="text-slate-400 text-sm font-medium">Monitoramento de receitas e taxas</p>
          </div>
        </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-16">
        ...
        <div className="lg:col-span-4">
          <div className="sticky top-8">
            <h2 className="text-lg font-bold text-slate-800 mb-8 flex items-center gap-2">
              {editId ? "Editar Recebível" : "Nova Receita"}
            </h2>
            <form onSubmit={handleSubmit} className="space-y-6">
              <div>
                <label className="block text-xs font-bold text-slate-400 uppercase tracking-widest mb-2 ml-1">Morador (ID)</label>
                <div className="relative">
                  ...
                  <input 
                    ...
                    placeholder="ID do morador" value={form.ID_MORADOR}
              ...
              <div>
                <label className="block text-xs font-bold text-slate-400 uppercase tracking-widest mb-2 ml-1">Descrição da Receita</label>
                <div className="relative">
                  ...
                  <textarea 
                    ...
                    placeholder="Ex: Taxa Condominial Ref. Junho" value={form.DESCRICAO}
              ...
              <div>
                <label className="block text-xs font-bold text-slate-400 uppercase tracking-widest mb-2 ml-1">Status do Recebimento</label>
                <div className="relative">
                  <select 
              ...
              {editId && (
                <button 
                  type="button"
                  onClick={() => { setEditId(null); setForm({ ID_MORADOR: "", DESCRICAO: "", VALOR: "", DATA_VENCIMENTO: "", STATUS: "" }); }}
        ...
        <div className="lg:col-span-8">
          <div className="flex items-center justify-between mb-8">
            <h2 className="text-lg font-bold text-slate-800">Entradas Financeiras</h2>
            ...
            <table className="w-full text-left border-separate border-spacing-y-4">
              <thead>
                <tr className="text-slate-400">
                  <th className="px-6 py-2 text-xs font-bold uppercase tracking-widest">Descrição / Devedor</th>
              ...
              <tbody>
                {contas.length === 0 ? (
                  <tr>
                    <td colSpan={4} className="px-6 py-20 text-center text-slate-300 font-medium">Nenhum recebível registrado.</td>
                  </tr>
                ) : (
                  contas.map((c: any) => (
                    <tr key={c.ID_CONTA_RECEBER} className="group">
                      ...
                      <td className="px-6 py-5 bg-slate-50/50 rounded-r-[1.5rem] border-y border-r border-slate-100 text-right group-hover:bg-emerald-50/30 transition-colors">
                        <div className="flex justify-end gap-2">
                          ...
                          <button 
                            onClick={() => handleDelete(c.ID_CONTA_RECEBER)} 
